...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_agentresourcetype', (
            ...
            ('direction', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ...
        # Adding field 'EconomicAgent.photo'
        db.add_column('valueaccounting_economicagent', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResourceType.photo'
        db.add_column('valueaccounting_economicresourcetype', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResourceType.url'
        db.add_column('valueaccounting_economicresourcetype', 'url',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EconomicAgent.photo'
        db.delete_column('valueaccounting_economicagent', 'photo')

        # Deleting field 'EconomicResourceType.photo'
        db.delete_column('valueaccounting_economicresourcetype', 'photo')

        # Deleting field 'EconomicResourceType.url'
        db.delete_column('valueaccounting_economicresourcetype', 'url')
