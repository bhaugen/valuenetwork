...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AgentResourceType.direction'
        db.delete_column('valueaccounting_agentresourcetype', 'direction')

        # Deleting field 'ProcessTypeResourceType.direction'
        db.delete_column('valueaccounting_processtyperesourcetype', 'direction')


    def backwards(self, orm):
        # Adding field 'AgentResourceType.direction'
        db.add_column('valueaccounting_agentresourcetype', 'direction',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=12),
                      keep_default=False)

        # Adding field 'ProcessTypeResourceType.direction'
        db.add_column('valueaccounting_processtyperesourcetype', 'direction',
                      self.gf('django.db.models.fields.CharField')(default='uses', max_length=12),
                      keep_default=False)
