...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.orderable'
        db.add_column('valueaccounting_category', 'orderable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.orderable'
        db.delete_column('valueaccounting_category', 'orderable')
