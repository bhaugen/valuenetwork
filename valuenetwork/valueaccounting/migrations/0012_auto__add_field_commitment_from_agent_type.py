...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commitment.from_agent_type'
        db.add_column('valueaccounting_commitment', 'from_agent_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='given_commitments', null=True, to=orm['valueaccounting.AgentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commitment.from_agent_type'
        db.delete_column('valueaccounting_commitment', 'from_agent_type_id')
