...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('applies_to', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('valueaccounting', ['Category'])

        # Adding field 'EconomicResourceType.category'
        db.add_column('valueaccounting_economicresourcetype', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resource_types', null=True, to=orm['valueaccounting.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('valueaccounting_category')

        # Deleting field 'EconomicResourceType.category'
        db.delete_column('valueaccounting_economicresourcetype', 'category_id')
    ...
    models = {
        ...
        'valueaccounting.category': {
            ...
            'applies_to': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
