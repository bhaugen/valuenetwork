...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ResourceRelationship.resource_effect'
        db.delete_column('valueaccounting_resourcerelationship', 'resource_effect')


    def backwards(self, orm):
        # Adding field 'ResourceRelationship.resource_effect'
        db.add_column('valueaccounting_resourcerelationship', 'resource_effect',
