...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceRelationship.inverse_name'
        db.add_column('valueaccounting_resourcerelationship', 'inverse_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceRelationship.inverse_name'
        db.delete_column('valueaccounting_resourcerelationship', 'inverse_name')
