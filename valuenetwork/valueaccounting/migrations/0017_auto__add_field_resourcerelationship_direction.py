...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceRelationship.direction'
        db.add_column('valueaccounting_resourcerelationship', 'direction',
                      self.gf('django.db.models.fields.CharField')(default='in', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceRelationship.direction'
        db.delete_column('valueaccounting_resourcerelationship', 'direction')
