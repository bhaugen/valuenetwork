...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_cachedeventsummary', (
            ...
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cached_events', null=True, to=orm['valueaccounting.Role'])),
            ('role_rate', self.gf('django.db.models.fields.DecimalField')(default='1.0', max_digits=8, decimal_places=2)),
