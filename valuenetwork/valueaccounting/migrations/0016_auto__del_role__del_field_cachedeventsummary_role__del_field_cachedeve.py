...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CachedEventSummary.role'
        db.delete_column('valueaccounting_cachedeventsummary', 'role_id')

        # Deleting field 'CachedEventSummary.role_rate'
        db.delete_column('valueaccounting_cachedeventsummary', 'role_rate')

        # Adding field 'CachedEventSummary.resource_type'
        db.add_column('valueaccounting_cachedeventsummary', 'resource_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cached_events', null=True, to=orm['valueaccounting.EconomicResourceType']),
                      keep_default=False)

        # Adding field 'CachedEventSummary.resource_type_rate'
        db.add_column('valueaccounting_cachedeventsummary', 'resource_type_rate',
                      self.gf('django.db.models.fields.DecimalField')(default='1.0', max_digits=8, decimal_places=2),
                      keep_default=False)

        # Deleting field 'EconomicEvent.from_agent_role'
        db.delete_column('valueaccounting_economicevent', 'from_agent_role_id')

        # Deleting field 'Commitment.from_agent_role'
        db.delete_column('valueaccounting_commitment', 'from_agent_role_id')

        # Adding field 'EconomicResourceType.rate'
        db.add_column('valueaccounting_economicresourcetype', 'rate',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'EconomicResourceType.created_by'
        db.add_column('valueaccounting_economicresourcetype', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resource_types_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'EconomicResourceType.changed_by'
        db.add_column('valueaccounting_economicresourcetype', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resource_types_changed', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('valueaccounting_role', (
            ...
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roles_changed', null=True, to=orm['auth.User'], blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roles_created', null=True, to=orm['auth.User'], blank=True)),
        ...
        # Adding field 'CachedEventSummary.role'
        db.add_column('valueaccounting_cachedeventsummary', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cached_events', null=True, to=orm['valueaccounting.Role'], blank=True),
                      keep_default=False)

        # Adding field 'CachedEventSummary.role_rate'
        db.add_column('valueaccounting_cachedeventsummary', 'role_rate',
                      self.gf('django.db.models.fields.DecimalField')(default='1.0', max_digits=8, decimal_places=2),
                      keep_default=False)

        # Deleting field 'CachedEventSummary.resource_type'
        db.delete_column('valueaccounting_cachedeventsummary', 'resource_type_id')

        # Deleting field 'CachedEventSummary.resource_type_rate'
        db.delete_column('valueaccounting_cachedeventsummary', 'resource_type_rate')

        # Adding field 'EconomicEvent.from_agent_role'
        db.add_column('valueaccounting_economicevent', 'from_agent_role',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', null=True, to=orm['valueaccounting.Role'], blank=True),
                      keep_default=False)

        # Adding field 'Commitment.from_agent_role'
        db.add_column('valueaccounting_commitment', 'from_agent_role',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='commitments', null=True, to=orm['valueaccounting.Role'], blank=True),
                      keep_default=False)

        # Deleting field 'EconomicResourceType.rate'
        db.delete_column('valueaccounting_economicresourcetype', 'rate')

        # Deleting field 'EconomicResourceType.created_by'
        db.delete_column('valueaccounting_economicresourcetype', 'created_by_id')

        # Deleting field 'EconomicResourceType.changed_by'
        db.delete_column('valueaccounting_economicresourcetype', 'changed_by_id')
    ...
    models = {
        ...
        'valueaccounting.commitment': {
            ...
            'commitment_date': ('django.db.models.fields.DateField', [], {}),
