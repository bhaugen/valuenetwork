...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgentResourceType.score'
        db.add_column('valueaccounting_agentresourcetype', 'score',
                      self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgentResourceType.score'
        db.delete_column('valueaccounting_agentresourcetype', 'score')
