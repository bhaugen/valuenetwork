...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commitment.independent_demand'
        db.add_column('valueaccounting_commitment', 'independent_demand',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dependent_commitments', null=True, to=orm['valueaccounting.Order']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commitment.independent_demand'
        db.delete_column('valueaccounting_commitment', 'independent_demand_id')
    ...
    models = {
        ...
        'valueaccounting.commitment': {
            ...
            'relationship': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'commitments'", 'null': 'True', 'to': "orm['valueaccounting.ResourceRelationship']"}),
