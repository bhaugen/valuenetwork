...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commitment.relationship'
        db.add_column('valueaccounting_commitment', 'relationship',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commitments', null=True, to=orm['valueaccounting.ResourceRelationship']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commitment.relationship'
        db.delete_column('valueaccounting_commitment', 'relationship_id')
