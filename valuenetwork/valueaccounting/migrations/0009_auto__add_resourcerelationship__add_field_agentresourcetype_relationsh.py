...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResourceRelationship'
        db.create_table('valueaccounting_resourcerelationship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('resource_effect', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ))
        db.send_create_signal('valueaccounting', ['ResourceRelationship'])

        # Adding field 'AgentResourceType.relationship'
        db.add_column('valueaccounting_agentresourcetype', 'relationship',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agent_resource_types', null=True, to=orm['valueaccounting.ResourceRelationship']),
                      keep_default=False)

        # Adding field 'ProcessTypeResourceType.relationship'
        db.add_column('valueaccounting_processtyperesourcetype', 'relationship',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='process_resource_types', null=True, to=orm['valueaccounting.ResourceRelationship']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ResourceRelationship'
        db.delete_table('valueaccounting_resourcerelationship')

        # Deleting field 'AgentResourceType.relationship'
        db.delete_column('valueaccounting_agentresourcetype', 'relationship_id')

        # Deleting field 'ProcessTypeResourceType.relationship'
        db.delete_column('valueaccounting_processtyperesourcetype', 'relationship_id')
    ...
    models = {
        ...
        'valueaccounting.cachedeventsummary': {
            'Meta': {'ordering': "('agent', 'project', 'role')", 'object_name': 'CachedEventSummary'},
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'cached_events'", 'null': 'True', 'to': "orm['valueaccounting.Role']"}),
            'role_rate': ('django.db.models.fields.DecimalField', [], {'default': "'1.0'", 'max_digits': '8', 'decimal_places': '2'}),
            'value': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'max_digits': '8', 'decimal_places': '2'})
        },
        ...
        'valueaccounting.resourcerelationship': {
            'Meta': {'object_name': 'ResourceRelationship'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
