...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feature.option_category'
        db.add_column('valueaccounting_feature', 'option_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='features', null=True, to=orm['valueaccounting.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feature.option_category'
        db.delete_column('valueaccounting_feature', 'option_category_id')
