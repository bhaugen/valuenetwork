...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessType.url'
        db.add_column('valueaccounting_processtype', 'url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessType.url'
        db.delete_column('valueaccounting_processtype', 'url')
