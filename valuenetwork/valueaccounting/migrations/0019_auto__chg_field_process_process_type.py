...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Process.process_type'
        db.alter_column('valueaccounting_process', 'process_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.ProcessType']))

    def backwards(self, orm):

        # Changing field 'Process.process_type'
        db.alter_column('valueaccounting_process', 'process_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['valueaccounting.ProcessType']))
