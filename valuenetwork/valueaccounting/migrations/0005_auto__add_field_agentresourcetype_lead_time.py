...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgentResourceType.lead_time'
        db.add_column('valueaccounting_agentresourcetype', 'lead_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgentResourceType.lead_time'
        db.delete_column('valueaccounting_agentresourcetype', 'lead_time')
