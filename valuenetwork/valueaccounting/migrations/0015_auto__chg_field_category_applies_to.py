...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category.applies_to'
        db.alter_column('valueaccounting_category', 'applies_to', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Category.applies_to'
        db.alter_column('valueaccounting_category', 'applies_to', self.gf('django.db.models.fields.CharField')(max_length=12))
