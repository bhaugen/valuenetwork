...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceRelationship.event_type'
        db.add_column('valueaccounting_resourcerelationship', 'event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resource_relationships', null=True, to=orm['valueaccounting.EventType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceRelationship.event_type'
        db.delete_column('valueaccounting_resourcerelationship', 'event_type_id')
