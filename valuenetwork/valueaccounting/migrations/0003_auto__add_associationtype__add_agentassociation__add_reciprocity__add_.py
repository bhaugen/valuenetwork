...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_reciprocity', (
            ...
            ('reciprocity_date', self.gf('django.db.models.fields.DateField')()),
        ))
        ...
        db.create_table('valueaccounting_commitment', (
            ...
            ('commitment_date', self.gf('django.db.models.fields.DateField')()),
            ...
            ('from_agent_role', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commitments', null=True, to=orm['valueaccounting.Role'])),
        ...
        # Adding field 'ProcessType.parent'
        db.add_column('valueaccounting_processtype', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sub_process_types', null=True, to=orm['valueaccounting.ProcessType']),
                      keep_default=False)

        # Adding field 'ProcessType.description'
        db.add_column('valueaccounting_processtype', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProcessType.estimated_duration'
        db.add_column('valueaccounting_processtype', 'estimated_duration',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EconomicEvent.commitment'
        db.add_column('valueaccounting_economicevent', 'commitment',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fulfillment_events', null=True, to=orm['valueaccounting.Commitment']),
                      keep_default=False)

        # Adding field 'EconomicResource.notes'
        db.add_column('valueaccounting_economicresource', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResourceType.description'
        db.add_column('valueaccounting_economicresourcetype', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProcessType.parent'
        db.delete_column('valueaccounting_processtype', 'parent_id')

        # Deleting field 'ProcessType.description'
        db.delete_column('valueaccounting_processtype', 'description')

        # Deleting field 'ProcessType.estimated_duration'
        db.delete_column('valueaccounting_processtype', 'estimated_duration')

        # Deleting field 'EconomicEvent.commitment'
        db.delete_column('valueaccounting_economicevent', 'commitment_id')

        # Deleting field 'EconomicResource.notes'
        db.delete_column('valueaccounting_economicresource', 'notes')

        # Deleting field 'EconomicResourceType.description'
        db.delete_column('valueaccounting_economicresourcetype', 'description')
    ...
    models = {
        ...
        'valueaccounting.agentresourcetype': {
            ...
            'direction': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'valueaccounting.commitment': {
            ...
            'from_agent_role': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'commitments'", 'null': 'True', 'to': "orm['valueaccounting.Role']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'valueaccounting.processtyperesourcetype': {
            'Meta': {'object_name': 'ProcessTypeResourceType'},
            'direction': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
