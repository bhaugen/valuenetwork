...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Commitment.order'
        db.add_column('valueaccounting_commitment', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commitments', null=True, to=orm['valueaccounting.Order']),
                      keep_default=False)

        # Adding field 'ProcessType.project'
        db.add_column('valueaccounting_processtype', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='process_types', null=True, to=orm['valueaccounting.Project']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Commitment.order'
        db.delete_column('valueaccounting_commitment', 'order_id')

        # Deleting field 'ProcessType.project'
        db.delete_column('valueaccounting_processtype', 'project_id')
