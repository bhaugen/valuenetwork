...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.main_process'
        db.delete_column('valueaccounting_project', 'main_process_id')

        # Adding field 'Process.project'
        db.add_column('valueaccounting_process', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='processes', null=True, to=orm['valueaccounting.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.main_process'
        db.add_column('valueaccounting_project', 'main_process',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_process', null=True, to=orm['valueaccounting.Process'], blank=True),
                      keep_default=False)

        # Deleting field 'Process.project'
        db.delete_column('valueaccounting_process', 'project_id')
